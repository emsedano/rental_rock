...
class PaymentOrdersControllerTest < ActionController::TestCase
  ...
  test "should create payment_order" do
    assert_difference('PaymentOrder.count') do
      post :create, payment_order: { amount: @payment_order.amount, contract_id: @payment_order.contract_id, payment_date: @payment_order.payment_date, payment_planned: @payment_order.payment_planned, receipt: @payment_order.receipt, status: @payment_order.status }
    end
  ...
  test "should update payment_order" do
    patch :update, id: @payment_order, payment_order: { amount: @payment_order.amount, contract_id: @payment_order.contract_id, payment_date: @payment_order.payment_date, payment_planned: @payment_order.payment_planned, receipt: @payment_order.receipt, status: @payment_order.status }
    assert_redirected_to payment_order_path(assigns(:payment_order))
  end
