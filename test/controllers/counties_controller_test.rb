...
class CountiesControllerTest < ActionController::TestCase
  ...
  test "should create county" do
    assert_difference('County.count') do
      post :create, county: { country_id: @county.country_id, name: @county.name, state_id: @county.state_id }
    end
  ...
  test "should update county" do
    patch :update, id: @county, county: { country_id: @county.country_id, name: @county.name, state_id: @county.state_id }
    assert_redirected_to county_path(assigns(:county))
  end
